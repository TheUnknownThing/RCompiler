#include "backend/passes/phiElimination.hpp"
...
void PhiElimination::eliminateCriticalEdge(ir::Function *func) {
  bool changed = true;
  while (changed) {
    changed = false;
...
void PhiElimination::eliminatePhiInFunction(ir::Function *func) {
  for (const auto &bb : func->blocks()) {
    bool changed = true;
    while (changed) {
      changed = false;
...
void PhiElimination::replaceCriticalEdge(ir::Function *func,
                                                ir::BasicBlock *from,
                                                ir::BasicBlock *to) {
