#include "backend/passes/pseudoAsmEmitter.hpp"
...
std::string PseudoAsmEmitter::opcodeName(InstOpcode opcode) const {
  switch (opcode) {
  case InstOpcode::ADD:
    return "add";
  case InstOpcode::SUB:
...
std::string PseudoAsmEmitter::operandName(
...
std::string PseudoAsmEmitter::instName(const AsmInst &inst) const {
