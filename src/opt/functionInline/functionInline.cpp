...
void FunctionInline::mergeMultipleReturns(ir::Function &function) {
...
void FunctionInline::checkInline(ir::Function &function) {
  bool changed = true;
  while (changed) {
    changed = false;
...
void FunctionInline::replaceAllUsesWith(ir::Function &function,
...
bool FunctionInline::judgeInline(ir::Function &function) {
